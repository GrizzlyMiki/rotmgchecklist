        ...
        <div class="card-body">
            <div class="row align-items-end">
                ...
                <div class="mx-auto pl-1" >
                    <button data-toggle="modal" data-target="#exampleModalCenter" data-itemid="${actualItem}" type="button" id="button${actualItem}" class="btn btn-primary mt-2 mb-1 py-1 px-2">
                    <i class="fas fa-camera"></i></button></div></div></div></div></div>`;
    }
